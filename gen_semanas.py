...
semanas = [
  ...
  },
  {
    ...
    "tareas_es": [
      "Generar el modelo base: en base/modelos/, ejecutar crear_SistemaUGV en MATLAB R2023b+ con la herramienta SysML (crea SistemaUGV.slx, un esqueleto). Copiarlo a modelos/sysml/ y abrirlo. Ya trae los bloques de primer nivel y el desglose interno del UGV — tu trabajo es rellenar las propiedades",
    ...
    "tareas_en": [
      "Generate the base model: in base/modelos/, run crear_SistemaUGV in MATLAB R2023b+ with the SysML tool (creates SistemaUGV.slx, a skeleton). Copy it to modelos/sysml/ and open it. It already has the top-level blocks and the UGV breakdown — your job is to fill in the properties",
    ...
    "entregables_es": [
      "EQUIPO — SistemaUGV.slx con el BDD de primer nivel y el desglose interno del bloque UGV: modelos/sysml/SistemaUGV.slx",
      "EQUIPO — Diagrama BDD exportado (PNG): semanas/semana-02/evidencias/",
      "EQUIPO — Tabla de propiedades (bloque · propiedad · tipo · valor · unidad · ID de requisito): semanas/semana-02/propiedades.csv",
      "EQUIPO — Informe de Arquitectura: semanas/semana-02/ficha_arquitectura_UGV.md",
      "1 Pull Request a master; 1 commit por rol: feat([rol]): propiedades del BDD nivel 1 — semana 2",
    ],
    "entregables_en": [
      "TEAM — SistemaUGV.slx with the top-level BDD and the internal breakdown of the UGV block: modelos/sysml/SistemaUGV.slx",
      "TEAM — Exported BDD diagram (PNG): semanas/semana-02/evidencias/",
      "TEAM — Property table (block · property · type · value · unit · requirement ID): semanas/semana-02/propiedades.csv",
      "TEAM — Architecture Report: semanas/semana-02/ficha_arquitectura_UGV.md",
    ...
    "materiales": [
      ...
      {"tipo":"md","nombre":"Informe de Arquitectura — entregable de equipo, a rellenar","archivo":"ficha_arquitectura_UGV.md"},
      {"tipo":"csv","nombre":"propiedades.csv — plantilla (cabecera + 1 fila de ejemplo)","archivo":"propiedades.csv"},
    ]
  },
  {
