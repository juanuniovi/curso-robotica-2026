...
semanas = [
  ...
  },
  {
    ...
    "entregables_es": [
      "SistemaUGV.slx con el BDD de primer nivel y el desglose interno del bloque UGV",
      "PNG del diagrama BDD",
      "Tabla propiedad · valor · unidad · ID de requisito (semanas/semana-02/propiedades.csv)",
      "1 Pull Request a master; 1 commit por rol: feat([rol]): propiedades del BDD nivel 1 — semana 2",
    ],
    "entregables_en": [
      "SistemaUGV.slx with the top-level BDD and the internal breakdown of the UGV block",
      "PNG of the BDD diagram",
      "Table property · value · unit · requirement ID (semanas/semana-02/propiedades.csv)",
