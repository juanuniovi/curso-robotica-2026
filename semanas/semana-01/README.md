...
|---|---|---|---|
| Ficha de comprensión (Partes A y B) | **Individual**, 1 por alumno | copiar [`comprension/comprension_EJEMPLO.md`](comprension/comprension_EJEMPLO.md) → `comprension_[tus-iniciales].md` | [`comprension/`](comprension/) |
| Informe de Requisitos (matriz SHALL + observaciones) | **Equipo** | [`ficha_requisitos_UGV.md`](ficha_requisitos_UGV.md) — rellenar directamente | esta carpeta |
| 15 requisitos ancla consolidados | **Equipo** (rol IS) | `requisitos_ancla.csv` — ver plantilla | [`../../recursos/requisitos_ancla.csv`](../../recursos/requisitos_ancla.csv) |
| Diagrama de contexto del Sistema UGV | **Equipo** | foto o PDF, nombrado `diagrama-contexto.jpg`/`.pdf` | [`diagrama-contexto/`](diagrama-contexto/) |
